...
@Component({
  selector: 'app-auditor-diagrams-filters-template-form',
  templateUrl: './auditor-diagrams-filters-template-form.component.html',
  styleUrls: ['./auditor-diagrams-filters-template-form.component.scss']
})
export class AuditorDiagramsFiltersTemplateFormComponent implements OnInit {
  ...
  constructor(
    ...
    private diagramsAdminFilters: AuditorDiagramsFiltersService) { }
